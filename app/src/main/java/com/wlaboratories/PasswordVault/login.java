                        ...
                        if (getIntent().hasExtra("login")) {
                            ...
                            if (delSuccess) {
                                ...
                                if (delDBsuccess) {
                                    ...
                                    Toast.makeText(getApplicationContext(),"Thank you for using Password Vault!",Toast.LENGTH_LONG).show();
                                    startActivity(i);
                                    finish();
                                } else {
                                    Toast.makeText(getApplicationContext(),"Could not delete database!",Toast.LENGTH_SHORT).show();
                                }
                            } else {
